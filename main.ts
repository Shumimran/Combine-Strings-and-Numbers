...
// with a number. For example, if provided with "Age: " and 30, it should give back 
// "Age:30".
...
let combineStingNumber =( text:string, number:number):string => {
    return text + number;
}

console.log(combineStingNumber ("age: ", 30));
